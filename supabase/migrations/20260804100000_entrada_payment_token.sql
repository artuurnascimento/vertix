-- =============================================================================
-- Checkout da entrada sem depender de "Gerar link"
-- =============================================================================
--
-- Após o aceite, a página da proposta mostrava "estamos gerando o seu link"
-- até alguém clicar em Gerar link no Financeiro. Expondo o payment_token da
-- entrada, o frontend monta /pagar/<token> na hora — checkout imediato.
-- O payment_link continua tendo precedência quando existir.
-- =============================================================================
