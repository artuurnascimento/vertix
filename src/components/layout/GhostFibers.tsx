// Componente "Ghost Fibers" do React Bits (https://reactbits.dev, licença MIT),
// copiado do registro oficial (GhostFibers-TS-CSS) sem alterações além deste
// cabeçalho e do caminho do CSS. Quem decide os parâmetros e quando ele
// aparece é Atmosfera.tsx — este arquivo é só o shader e o laço de render.
