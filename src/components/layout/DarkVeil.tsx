// Componente "Dark Veil" do React Bits (https://reactbits.dev, licença MIT),
// copiado do registro oficial (DarkVeil-TS-CSS) sem alterações além deste
// cabeçalho. Quem decide os parâmetros e quando ele aparece é Atmosfera.tsx —
// este arquivo é só o shader (uma CPPN) e o laço de render.
